...
-   Customization options:
    ...
    -   Create and open Simple Daily Notes on startup
-   Save custom presets for quick access to specific folders or tags
-   Navigate between notes using keyboard shortcuts (up/down)
-   Right-click on folders to open all notes in that folder in Simple Daily Notes
...
-   **Create and open Simple Daily Notes on startup**: Automatically create today's daily note and open the Simple Daily Notes when Obsidian starts
-   **Presets**: Save and manage custom presets for quick access to specific folders or tags

# Usage

1. Click the calendar icon in the left ribbon or use the command "Open Simple Daily Notes"
...
4. Right-click on any folder in the file explorer to open all notes from that folder in Simple Daily Notes
